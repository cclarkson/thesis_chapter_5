...
#######################################################################
##########    						                                        #####
########## CHI SQUARE PROABILITY CALCULATOR   Ter vs mer (6 vs 1) #####
...
print OUTPUT "contig\tposition\tchi2TeremivMerus\n";
...
while(my $line = <INPUT>){
	...
	my @A1 = @alleles[16,17,18,19,20,21];
	my @A2 = @alleles[22];
