...
#######################################################################
##########    						                             ######
########## CHI-SQUARE PROBABILITY CALCULATOR FOR MD vs T (3 vs 3)######
...
print OUTPUT "contig\tposition\tchi2MD1vMD2\tchi2T1vT2\tchi2MD1vT1\tchi2MD2vT2\n";
...
while(my $line = <INPUT>){
	...
	my @A1 = @alleles[0,4,6,7,9];
	my @A2 = @alleles[1,2,3,5,8];
	my @D1 = @alleles[16,18,20];
	my @D2 = @alleles[17,19,21];
